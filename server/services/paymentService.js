...
const PAYHERO_CONFIG = {
  ...
  // OLD CHANNEL (Backup reference: Channel ID 3398, Account ID 3398)
  // If needed to revert: API_KEY='6CUxNcfi9jRpr4eWicAn', API_SECRET='j6zP2XpAlXn9UhtHOj9PbYQVAdlQnkeyrEWuFOAH'
